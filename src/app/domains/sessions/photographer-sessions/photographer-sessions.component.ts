...
@Component({
  selector: 'photographer-sessions',
  imports: [CommonModule, IconDirective, FormsModule, NgbModule],
  templateUrl: './photographer-sessions.component.html',
  styleUrls: ['./photographer-sessions.component.scss']
})
export class PhotographerSessionsComponent {
